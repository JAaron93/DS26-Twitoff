'''
Handles Data Science Prediction Model
'''
...
def predict_user(user0_name, user1_name, hypo_tweet_text):
    ...
    Example run: predict_user('youyanggu;, 'kareem_carr', "Machine Learning isn't just statistics.")
    Return a 0 (user0_name) or a 1 (user1_name).
    """
    # Grabs users from our Database.
    # .one() is to grab the first instance of the user
